...
namespace WTXModbus
{
    ...
    static class Program
    {
        ...
        static void Main()
        {
            ...
            Modbus_TCP_obj = new ModbusTCP("172.19.103.8");
        ...
        private static void MeasureZero()
        {
            ...
            WTX_obj.write_Zero__Calibration_Nominal_Load('z', 0x7FFFFFFF, Write_DataReceived);           // 'z' steht für das Setzen der zero load.
        ...
        private static void Calibrate(int calibrationValue)
        {
            ...
            WTX_obj.write_Zero__Calibration_Nominal_Load('c', calibrationValue, Write_DataReceived);          // 'c' steht für das Setzen der Calibration Weight.

            //write reg 50, 0x7FFFFFFF

            WTX_obj.write_Zero__Calibration_Nominal_Load('n', 0x7FFFFFFF, Write_DataReceived);       // 'n' steht für das Setzen der Nominal Load 
        ...
        {            
            ...
            WTX_obj.write_Zero__Calibration_Nominal_Load('z', Convert.ToInt32(DPreload), Write_DataReceived);

            WTX_obj.SyncCall_Write_Command(0, 0x80, Write_DataReceived);

            //write reg 50, DNominalLoad;

            WTX_obj.write_Zero__Calibration_Nominal_Load('n', Convert.ToInt32(DNominalLoad), Write_DataReceived);
        ...
        private static void reset_values_on_console(IDeviceValues Device_Values)
        {
            ...
            if (Device_Values.application_mode == 0 || Device_Values.application_mode == 2 || Device_Values.application_mode == 1)   // If the device is a compatible mode (standard=0 or filler=1 | filler=2) 
            {
                ...
                {
                    Console.WriteLine("Net value:                     " + data_str_arr[0] + "\t  As an Integer:  " + Device_Values.NetValue);
                    Console.WriteLine("Gross value:                   " + data_str_arr[1] + "\t  As an Integer:  " + Device_Values.GrossValue);
                }
                else
                        if (input_numInputs == 5)
                {
                    Console.WriteLine("Net value:                     " + data_str_arr[0] + "\t  As an Integer:  " + Device_Values.NetValue);
                    Console.WriteLine("Gross value:                   " + data_str_arr[1] + "\t  As an Integer:  " + Device_Values.GrossValue);
                    Console.WriteLine("General weight error:          " + data_str_arr[2] + "\t  As an Integer:  " + Device_Values.general_weight_error);
                    Console.WriteLine("Scale alarm triggered:         " + data_str_arr[3] + "\t  As an Integer:  " + Device_Values.limit_status);
                    Console.WriteLine("Scale seal is open:            " + data_str_arr[6] + "\t  As an Integer:  " + Device_Values.scale_seal_is_open);
                    Console.WriteLine("Manual tare:                   " + data_str_arr[7] + "\t  As an Integer:  " + Device_Values.manual_tare);
                    Console.WriteLine("Weight type:                   " + data_str_arr[8] + "\t  As an Integer:  " + Device_Values.weight_type);
                    Console.WriteLine("Scale range:                   " + data_str_arr[9] + "\t  As an Integer:  " + Device_Values.scale_range);
                    Console.WriteLine("Zero required/True zero:       " + data_str_arr[10] + "\t  As an Integer:  " + Device_Values.zero_required);
                    Console.WriteLine("Weight within center of zero:  " + data_str_arr[11] + "\t  As an Integer:  " + Device_Values.weight_within_the_center_of_zero);
                    Console.WriteLine("Weight in zero range:          " + data_str_arr[12] + "\t  As an Integer:  " + Device_Values.weight_within_the_center_of_zero);
                    Console.WriteLine("Limit status:                  " + data_str_arr[4] + "  As an Integer:  " + Device_Values.limit_status);
                    Console.WriteLine("Weight moving:                 " + data_str_arr[5] + "  As an Integer:" + Device_Values.weight_moving);
                }
                else
                if (input_numInputs == 6 || input_numInputs == 38)
                {
                    ...
                    Console.WriteLine("Weight within center of zero:  " + data_str_arr[11] + "\t  As an Integer:  " + Device_Values.weight_within_the_center_of_zero);
                    Console.WriteLine("Weight in zero range:          " + data_str_arr[12] + "\t  As an Integer:  " + Device_Values.weight_within_the_center_of_zero);
                    Console.WriteLine("Application mode:              " + data_str_arr[13] + "\t  As an Integer:  " + Device_Values.application_mode);
                    Console.WriteLine("Decimal places:                " + data_str_arr[14] + "\t  As an Integer:  " + Device_Values.decimals);
                    Console.WriteLine("Unit:                          " + data_str_arr[15] + "\t  As an Integer:  " + Device_Values.unit);
                    Console.WriteLine("Handshake:                     " + data_str_arr[16] + "\t  As an Integer:  " + Device_Values.handshake);
                    Console.WriteLine("Status:                        " + data_str_arr[17] + "\t  As an Integer:  " + Device_Values.status);
