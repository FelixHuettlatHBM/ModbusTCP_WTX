...
namespace WTXModbus
{
    ...
    static class Program
    {
        ...
        static void Main(string[] args)
		{
            ...
            Console.WriteLine("\nModbus/TCP interface for WTX weighting terminals from HBM\nEnter e to exit the application");
            Console.WriteLine("\n\n Connecting IP adress: " + ipAddress + " ...");

            input_IP_Adress =ipAddress;


            Modbus_TCP_obj = new ModbusTCP(ipAddress);
            ...
            {
                Console.WriteLine("\nModbus/TCP interface for WTX weighting terminals of HBM");
                Console.WriteLine("\nConnection failed!\n Bye, bye...");
                Thread.Sleep(4000);
            }
        ...
        private static void OnTimedEvent(Object source, ElapsedEventArgs e)
        {
            if (compare_data_received == false && compare_values_changed == true)
                Console.WriteLine("\n\n\n\tMeasurement time: {0:HH:mm:ss.fff}. \nNo values - Connection failed. Exit with 'e' .\n", e.SignalTime);
