...
namespace Hbm.Devices.WTXModbus
{
    ...
    public class WTX120 : ICallAsyncEvent, IDeviceValues
    {
        ...
        public void HandleDataEvent(object sender, MessageEvent e)
        {
            ...
            //this.data_str[0] = this.measurement_with_comma(this.NetandGrossValue, this.decimals);  // 0 equal to "Net and gross measured" as a parameter 
            this.data_str[1] = this.measurement_with_comma(this.NetValue, this.decimals);  // 1 equal to "Net measured" as a parameter
            this.data_str[2] = this.measurement_with_comma(this.GrossValue, this.decimals);  // 2 equal to "Gross measured" as a parameter
